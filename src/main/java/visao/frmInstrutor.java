...
public class frmInstrutor extends javax.swing.JFrame {
    ...
    public void listar(){
        ...
        List<Instrutor> lista = dao.listarInstrutor();
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Cadastro Dos Instrutores");
        ...
        jTabbedPane1.addTab("Dados dos Instrutores", painel_dados);
        ...
        tbCliente.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Código", "RG", "Nome", "Nascimento", "Titulação"
            }
        ));
        ...
        jTabbedPane1.addTab("Consulta De Instrutores", jPanel3);
    ...
    private void btEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditarActionPerformed
        ...
        obj.setIdInstrutor(Integer.parseInt(txtCodigo.getText()));
        obj.setRg(Integer.parseInt(txtRG.getText()));
        obj.setNome(txtNome.getText());
        obj.setNascimento((txtNascimento.getText()));
        obj.setTitulacao(Integer.parseInt(txtTitulacao.getText()));
        
        
        
        IstrutorDAO dao = new IstrutorDAO();
        
        dao.alterarInstrutor(obj);
    ...
    private void btnPesquisaClienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnPesquisaClienteMouseClicked
        ...
        IstrutorDAO dao = new IstrutorDAO();
        List<Instrutor> lista = dao.buscaInstrutorPorNome(nome);
