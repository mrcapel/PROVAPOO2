...
public class frmAlunos extends javax.swing.JFrame {
    ...
    public void listar(){
        ...
        List<Alunos> lista = dao.listarAlunos();
    ...
    private void initComponents() {
                ...
                .addGroup(painel_dadosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(painel_dadosLayout.createSequentialGroup()
                        ...
                        .addGroup(painel_dadosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(txtIdTurma, javax.swing.GroupLayout.PREFERRED_SIZE, 78, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(painel_dadosLayout.createSequentialGroup()
                        .addGroup(painel_dadosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(painel_dadosLayout.createSequentialGroup()
        ...
        tbCliente.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Id Matricula", "Id Turma", "Data Matricula", "Nome", "Endereço", "Telefone", "Data Nascimento", "Altura", "Peso"
            }
        ));
        ...
        jTabbedPane1.addTab("Consulta De Alunos", jPanel3);
    ...
    private void btEditarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btEditarActionPerformed
        ...
        obj.setCodMatricula(Integer.parseInt(txtIdMatricula.getText()));
        obj.setIdTurma(Integer.parseInt(txtIdTurma.getText()));
        obj.setNome(txtNome.getText());
        obj.setTelefone(Integer.parseInt(txtTelefone.getText()));
        obj.setDataMatricula(txtEmail.getText());
        obj.setEndereco(txtEndereco.getText());
        obj.setDataNascimento(txtNumero.getText());
        obj.setAltura(Double.parseDouble(txtBairro.getText()));
        obj.setPeso(Integer.parseInt(txtCidade.getText()));
        
        AlunosDAO dao = new AlunosDAO();
        
        dao.alterarAlunos(obj);
    ...
    private void tbClienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tbClienteMouseClicked
        ...
        txtIdMatricula.setText(tbCliente.getValueAt(tbCliente.getSelectedRow(), 0).toString());
        txtIdTurma.setText(tbCliente.getValueAt(tbCliente.getSelectedRow(), 1).toString());
        txtNome.setText(tbCliente.getValueAt(tbCliente.getSelectedRow(), 3).toString());
        txtEmail.setText(tbCliente.getValueAt(tbCliente.getSelectedRow(), 2).toString());
        txtTelefone.setText(tbCliente.getValueAt(tbCliente.getSelectedRow(), 5).toString());
        txtEndereco.setText(tbCliente.getValueAt(tbCliente.getSelectedRow(), 4).toString());
        txtNumero.setText(tbCliente.getValueAt(tbCliente.getSelectedRow(), 6).toString());
        txtBairro.setText(tbCliente.getValueAt(tbCliente.getSelectedRow(), 7).toString());
        txtCidade.setText(tbCliente.getValueAt(tbCliente.getSelectedRow(), 8).toString());
    ...
    private void btnPesquisaClienteMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_btnPesquisaClienteMouseClicked
        ...
        AlunosDAO dao = new AlunosDAO();
        List<Alunos> lista = dao.buscaAlunosPorNome(nome);
